...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.25\textwidth]{../src/os.png}}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.25\textwidth]{../src/kernel.png}}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{../src/distro.png}}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{../src/gui.png}}
    \caption{GUI \texttt{//Source:WiKi}}
\end{figure}

\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{../src/cli.png}}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{../src/vmware.png}}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{../src/verification.png}}
