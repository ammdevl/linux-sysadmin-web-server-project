...
\begin{titlepage}
    ...
    {\large Faculty of Computer Science and Technology} \\[0.2cm]
    {\large 2025 - 2026 Academic Year} \\[1.5cm]
   
    \includegraphics[width=0.2\textwidth]{ucsy-logo.png} \\[1.5cm]
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{os.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{distro.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{vmware.png}
